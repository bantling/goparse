...
//// ====
//
//// TerminalPart is a string or character range
...
//}
//
//// OfTerminalPartString constructs a Terminal from a string
//func OfTerminalPartString(sourceString, terminalString string) Terminal {
//	return Terminal{
